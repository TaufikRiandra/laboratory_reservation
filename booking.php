...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const previewSubtitle = document.querySelector('.preview-card p');
            const previewDetails = document.querySelector('.preview-card > div:nth-child(4)');
            ...
            labOptions.forEach(option => {
                option.addEventListener('change', function() {
                    if (this.checked) {
                        ...
                        previewTitle.textContent = 'Lab ' + labId;
                        previewSubtitle.textContent = 'Gedung ' + labId;
